...
public class JMS2MessageSenderBean implements JMS2MessageSender {
    ...
    public <T extends Object> void sendMessage(Destination destination,
                            T businessObject) {
...
//
//    public void sendObjectMessage(Destination destination, Object object) {
//        LOG.info("Sending object message");
//        context.createProducer().send(destination, messageConverter.serialize(context, object));
//    }
